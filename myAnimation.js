...
p.nominalBounds = new cjs.Rectangle(0,0,3003,2125);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(2820.4228,1242.7769);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).to({state:[]},870).to({state:[{t:this.shape},{t:this.shape_1}]},117).wait(240));
...
if (reversed == null) { reversed = false; }
	...
	// background0
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#63DAE7").s().p("EmxYClwMAAAlLfMNixAAAMAAAFLfg");
	this.shape.setTransform(226.25,939.2);

	this.instance = new lib.CachedBmp_1();
	this.instance.setTransform(-0.75,-61.55,0.5,0.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1.5,1,1).p("Eh1LhS3MDqXAAAMAAAClvMjqXAAAg");
	this.shape_1.setTransform(750,469.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(3,1,1).p("EjqXilvMHUvAAAMAAAFLfMnUvAAA");
	this.shape_2.setTransform(1500,939.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#63DAE7").s().p("EgjWClwMmOCAAAMAAAlLfMGOCAAAMHUvAAAMAAAFLfg");
	this.shape_3.setTransform(226.25,939.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.instance},{t:this.shape}]}).to({state:[]},870).to({state:[{t:this.shape_3},{t:this.shape_2}]},117).wait(240));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(870).to({_off:false},0).wait(117));
...
if (reversed == null) { reversed = false; }
	...
	// backgroud2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#009900").ss(3,1,1).p("");
	this.shape.setTransform(-820.0659,1503.05);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#CCFFCC").s().p("");
	this.shape_1.setTransform(165.2187,1340.2269);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#04C2F6").s().p("");
	this.shape_2.setTransform(382.4074,1252.2269);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#7DB453").s().p("");
	this.shape_3.setTransform(-820.0659,1503.05);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[]},870).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape_3},{t:this.shape}]},117).wait(240));
...
if (reversed == null) { reversed = false; }
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},90).wait(10));
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(3,1,1).p("");
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("rgba(153,255,204,0.839)").s().p("");
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(3,1,1).p("");
	this.shape_6.setTransform(479.0031,222.2992);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("rgba(153,255,204,0.839)").s().p("");
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("play", "300px 'Segoe Script'");
	this.text.textAlign = "center";
	this.text.lineHeight = 477;
	this.text.lineWidth = 733;
	this.text.parent = this;
	this.text.setTransform(453.9,187.05);
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(255,255,255,0.62)").s().p("EgyEAyEQ0v0vAA9VQAA9UUv0vQUw0vdUAAQdVAAUwUvQUuUvAAdUQAAdV0uUvQ0wUv9VAAQ9UAA0w0vg");
	this.shape_1.setTransform(453.15,453.125);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1,p:{y:453.125}},{t:this.shape,p:{y:453.125}},{t:this.text,p:{y:187.05}}]}).to({state:[{t:this.shape_1,p:{y:450.625}},{t:this.shape,p:{y:450.625}},{t:this.text,p:{y:184.55}}]},4).to({state:[{t:this.shape_1,p:{y:448.125}},{t:this.shape,p:{y:448.125}},{t:this.text,p:{y:182.05}}]},4).to({state:[{t:this.shape_1,p:{y:445.625}},{t:this.shape,p:{y:445.625}},{t:this.text,p:{y:179.55}}]},4).to({state:[{t:this.shape_1,p:{y:443.125}},{t:this.shape,p:{y:443.125}},{t:this.text,p:{y:177.05}}]},5).to({state:[{t:this.shape_1,p:{y:440.625}},{t:this.shape,p:{y:440.625}},{t:this.text,p:{y:174.55}}]},4).to({state:[{t:this.shape_1,p:{y:443.125}},{t:this.shape,p:{y:443.125}},{t:this.text,p:{y:177.05}}]},4).to({state:[{t:this.shape_1,p:{y:445.625}},{t:this.shape,p:{y:445.625}},{t:this.text,p:{y:179.55}}]},4).to({state:[{t:this.shape_1,p:{y:448.125}},{t:this.shape,p:{y:448.125}},{t:this.text,p:{y:182.05}}]},5).to({state:[{t:this.shape_1,p:{y:450.625}},{t:this.shape,p:{y:450.625}},{t:this.text,p:{y:184.55}}]},4).wait(4));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1,-13.5,908.3,920.8);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("Play \nagain", "200px 'Segoe Script'");
	this.text.textAlign = "center";
	this.text.lineHeight = 319;
	this.text.lineWidth = 964;
	this.text.parent = this;
	this.text.setTransform(438.5,126.55);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1,p:{y:453.125}},{t:this.shape,p:{y:453.125}},{t:this.text,p:{y:126.55}}]}).to({state:[{t:this.shape_1,p:{y:446.725}},{t:this.shape,p:{y:446.725}},{t:this.text,p:{y:120.15}}]},4).to({state:[{t:this.shape_1,p:{y:440.325}},{t:this.shape,p:{y:440.325}},{t:this.text,p:{y:113.75}}]},4).to({state:[{t:this.shape_1,p:{y:433.925}},{t:this.shape,p:{y:433.925}},{t:this.text,p:{y:107.35}}]},3).to({state:[{t:this.shape_1,p:{y:427.525}},{t:this.shape,p:{y:427.525}},{t:this.text,p:{y:100.95}}]},4).to({state:[{t:this.shape_1,p:{y:433.925}},{t:this.shape,p:{y:433.925}},{t:this.text,p:{y:107.35}}]},4).to({state:[{t:this.shape_1,p:{y:440.325}},{t:this.shape,p:{y:440.325}},{t:this.text,p:{y:113.75}}]},4).to({state:[{t:this.shape_1,p:{y:446.725}},{t:this.shape,p:{y:446.725}},{t:this.text,p:{y:120.15}}]},3).wait(4));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-45.6,-26.6,968.2,960.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1597.85,366.85,1,1,-105.0005,0,0,46.4,36.5);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(875).to({_off:false},0).wait(1).to({regX:48.8,regY:40.8,rotation:-105.454,x:-1597.3,y:357.2},0).wait(1).to({rotation:-105.929,x:-1600.25,y:351.05},0).wait(1).to({rotation:-106.411,x:-1603.25,y:345.1},0).wait(1).to({rotation:-106.9,x:-1606.25,y:339.2},0).wait(1).to({rotation:-107.397,x:-1609.25,y:333.45},0).wait(1).to({rotation:-107.902,x:-1612.3,y:327.7},0).wait(1).to({rotation:-108.415,x:-1615.3,y:322.15},0).wait(1).to({rotation:-108.935,x:-1618.35,y:316.65},0).wait(1).to({rotation:-109.464,x:-1621.45,y:311.3},0).wait(1).to({rotation:-110.001,x:-1624.5,y:306},0).wait(1).to({rotation:-110.547,x:-1627.6,y:300.8},0).wait(1).to({rotation:-111.102,x:-1630.7,y:295.6},0).wait(1).to({rotation:-111.665,x:-1633.8,y:290.65},0).wait(1).to({rotation:-112.237,x:-1636.95,y:285.7},0).wait(1).to({rotation:-112.818,x:-1640.05,y:280.85},0).wait(1).to({rotation:-113.408,x:-1643.25,y:276.1},0).wait(1).to({rotation:-114.008,x:-1646.4,y:271.4},0).wait(1).to({rotation:-114.617,x:-1649.6,y:266.85},0).wait(1).to({rotation:-115.236,x:-1652.75,y:262.35},0).wait(1).to({rotation:-115.864,x:-1656,y:257.95},0).wait(1).to({rotation:-116.503,x:-1659.2,y:253.65},0).wait(1).to({rotation:-117.151,x:-1662.4,y:249.4},0).wait(1).to({rotation:-117.809,x:-1665.65,y:245.2},0).wait(1).to({rotation:-118.478,x:-1668.9,y:241.15},0).wait(1).to({rotation:-119.156,x:-1672.15,y:237.1},0).wait(1).to({rotation:-119.845,x:-1675.5,y:233.2},0).wait(1).to({rotation:-120.545,x:-1678.75,y:229.3},0).wait(1).to({rotation:-121.255,x:-1682.05,y:225.65},0).wait(1).to({rotation:-121.976,x:-1685.45,y:221.9},0).wait(1).to({rotation:-122.707,x:-1688.75,y:218.3},0).wait(1).to({rotation:-123.449,x:-1692.15,y:214.8},0).wait(1).to({rotation:-124.201,x:-1695.55,y:211.3},0).wait(1).to({rotation:-124.964,x:-1698.9,y:207.9},0).wait(1).to({rotation:-125.738,x:-1702.35,y:204.6},0).wait(1).to({rotation:-126.523,x:-1705.75,y:201.4},0).wait(1).to({rotation:-127.318,x:-1709.2,y:198.25},0).wait(1).to({rotation:-128.123,x:-1712.65,y:195.15},0).wait(1).to({rotation:-128.94,x:-1716.05,y:192.15},0).wait(1).to({rotation:-129.766,x:-1719.55,y:189.25},0).wait(1).to({rotation:-130.603,x:-1723.05,y:186.35},0).wait(1).to({rotation:-131.451,x:-1726.55,y:183.55},0).wait(1).to({rotation:-132.308,x:-1730.15,y:180.85},0).wait(1).to({rotation:-133.175,x:-1733.7,y:178.25},0).wait(1).to({rotation:-134.052,x:-1737.3,y:175.7},0).wait(1).to({rotation:-134.938,x:-1740.8,y:173.15},0).wait(1).to({rotation:-135.834,x:-1744.4,y:170.75},0).wait(1).to({rotation:-136.739,x:-1748.05,y:168.35},0).wait(1).to({rotation:-137.652,x:-1751.65,y:166.1},0).wait(1).to({rotation:-138.574,x:-1755.35,y:163.85},0).wait(1).to({rotation:-139.504,x:-1759,y:161.7},0).wait(1).to({rotation:-140.442,x:-1762.65,y:159.6},0).wait(1).to({rotation:-141.388,x:-1766.4,y:157.6},0).wait(1).to({rotation:-142.34,x:-1770.1,y:155.7},0).wait(1).to({rotation:-143.3,x:-1773.85,y:153.85},0).wait(1).to({rotation:-144.265,x:-1777.55,y:152.05},0).wait(1).to({rotation:-145.236,x:-1781.4,y:150.35},0).wait(1).to({rotation:-146.213,x:-1785.15,y:148.65},0).wait(1).to({rotation:-147.195,x:-1788.95,y:147.05},0).wait(1).to({rotation:-148.18,x:-1792.8,y:145.55},0).wait(1).to({rotation:-149.17,x:-1796.65,y:144.05},0).wait(1).to({rotation:-150.163,x:-1800.55,y:142.65},0).wait(1).to({rotation:-151.159,x:-1804.4,y:141.35},0).wait(1).to({rotation:-152.158,x:-1808.3,y:140.1},0).wait(1).to({rotation:-153.158,x:-1812.25,y:138.95},0).wait(1).to({rotation:-154.159,x:-1816.1,y:137.9},0).wait(1).to({rotation:-155.161,x:-1820.1,y:136.85},0).wait(1).to({rotation:-156.163,x:-1824.1,y:135.9},0).wait(1).to({rotation:-157.164,x:-1828.05,y:134.95},0).wait(1).to({rotation:-158.165,x:-1832.15,y:134.15},0).wait(1).to({rotation:-159.164,x:-1836.15,y:133.35},0).wait(1).to({rotation:-160.16,x:-1840.2,y:132.65},0).wait(1).to({rotation:-161.154,x:-1844.3,y:132.05},0).wait(1).to({rotation:-162.145,x:-1848.4,y:131.5},0).wait(1).to({rotation:-163.132,x:-1852.5,y:131},0).wait(1).to({rotation:-164.115,x:-1856.7,y:130.6},0).wait(1).to({rotation:-165.093,x:-1860.8,y:130.25},0).wait(1).to({rotation:-166.066,x:-1865,y:129.95},0).wait(1).to({rotation:-167.033,x:-1869.2,y:129.75},0).wait(1).to({rotation:-167.994,x:-1873.45,y:129.65},0).wait(1).to({rotation:-168.949,x:-1877.7,y:129.55},0).wait(1).to({rotation:-169.896,x:-1881.95,y:129.6},0).wait(1).to({rotation:-170.837,x:-1886.25,y:129.65},0).wait(1).to({rotation:-171.769,x:-1890.55,y:129.75},0).wait(1).to({rotation:-172.694,x:-1894.9,y:130},0).wait(1).to({rotation:-173.61,x:-1899.25,y:130.25},0).wait(1).to({rotation:-174.517,x:-1903.65,y:130.65},0).wait(1).to({rotation:-175.416,x:-1908.05,y:131.1},0).wait(1).to({rotation:-176.305,x:-1912.45,y:131.6},0).wait(1).to({rotation:-177.185,x:-1916.95,y:132.15},0).wait(1).to({rotation:-178.055,x:-1921.4,y:132.8},0).wait(1).to({rotation:-178.916,x:-1925.95,y:133.55},0).wait(1).to({rotation:-179.766,x:-1930.5,y:134.3},0).wait(1).to({rotation:-180.607,x:-1935.05,y:135.15},0).wait(1).to({rotation:-181.437,x:-1939.6,y:136.05},0).wait(1).to({rotation:-182.257,x:-1944.2,y:137.1},0).wait(1).to({rotation:-183.066,x:-1948.9,y:138.2},0).wait(1).to({rotation:-183.865,x:-1953.55,y:139.4},0).wait(1).to({rotation:-184.653,x:-1958.2,y:140.6},0).wait(1).to({rotation:-185.431,x:-1962.95,y:141.95},0).wait(1).to({rotation:-186.198,x:-1967.7,y:143.3},0).wait(1).to({rotation:-186.955,x:-1972.5,y:144.8},0).wait(1).to({rotation:-187.701,x:-1977.25,y:146.35},0).wait(1).to({rotation:-188.436,x:-1982.15,y:147.95},0).wait(1).to({rotation:-189.161,x:-1987.05,y:149.65},0).wait(1).to({rotation:-189.875,x:-1991.95,y:151.45},0).wait(1).to({rotation:-190.579,x:-1996.85,y:153.3},0).wait(1).to({rotation:-191.273,x:-2001.85,y:155.3},0).wait(1).to({rotation:-191.956,x:-2006.85,y:157.3},0).wait(1).to({rotation:-192.629,x:-2011.85,y:159.4},0).wait(1).to({rotation:-193.292,x:-2017,y:161.6},0).wait(1).to({rotation:-193.945,x:-2022.1,y:163.9},0).wait(1).to({rotation:-194.588,x:-2027.25,y:166.25},0).wait(1).to({rotation:-195.222,x:-2032.4,y:168.75},0).wait(1).to({rotation:-195.845,x:-2037.65,y:171.25},0).wait(1).to({rotation:-196.46,x:-2042.9,y:173.9},0).wait(1).to({rotation:-197.064,x:-2048.15,y:176.6},0).wait(1).to({rotation:-197.66,x:-2053.55,y:179.4},0).wait(1).to({rotation:-198.246,x:-2058.9,y:182.35},0).wait(1).to({rotation:-198.824,x:-2064.35,y:185.35},0).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// trears_3
	this.instance = new lib.trears("synched",0);
	this.instance.setTransform(-1598.05,366.85,1,1,-105.0005,0,0,45.6,35.2);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(873).to({_off:false},0).wait(1).to({regX:48.8,regY:40.8,rotation:-105.432,x:-1595.75,y:357.45},0).wait(1).to({rotation:-105.887,x:-1598.1,y:352.7},0).wait(1).to({rotation:-106.354,x:-1600.45,y:348.05},0).wait(1).to({rotation:-106.833,x:-1602.8,y:343.55},0).wait(1).to({rotation:-107.326,x:-1605.1,y:339.05},0).wait(1).to({rotation:-107.831,x:-1607.4,y:334.75},0).wait(1).to({rotation:-108.35,x:-1609.7,y:330.5},0).wait(1).to({rotation:-108.884,x:-1612.05,y:326.4},0).wait(1).to({rotation:-109.432,x:-1614.4,y:322.35},0).wait(1).to({rotation:-109.996,x:-1616.65,y:318.35},0).wait(1).to({rotation:-110.575,x:-1618.95,y:314.45},0).wait(1).to({rotation:-111.172,x:-1621.25,y:310.7},0).wait(1).to({rotation:-111.785,x:-1623.55,y:307.05},0).wait(1).to({rotation:-112.416,x:-1625.9,y:303.45},0).wait(1).to({rotation:-113.066,x:-1628.15,y:299.95},0).wait(1).to({rotation:-113.735,x:-1630.5,y:296.6},0).wait(1).to({rotation:-114.425,x:-1632.8,y:293.2},0).wait(1).to({rotation:-115.134,x:-1635.1,y:289.95},0).wait(1).to({rotation:-115.866,x:-1637.45,y:286.85},0).wait(1).to({rotation:-116.619,x:-1639.75,y:283.7},0).wait(1).to({rotation:-117.396,x:-1642.05,y:280.75},0).wait(1).to({rotation:-118.197,x:-1644.35,y:277.85},0).wait(1).to({rotation:-119.022,x:-1646.6,y:275.05},0).wait(1).to({rotation:-119.873,x:-1648.95,y:272.35},0).wait(1).to({rotation:-120.751,x:-1651.3,y:269.65},0).wait(1).to({rotation:-121.656,x:-1653.6,y:267.1},0).wait(1).to({rotation:-122.59,x:-1655.95,y:264.6},0).wait(1).to({rotation:-123.552,x:-1658.25,y:262.2},0).wait(1).to({rotation:-124.545,x:-1660.55,y:259.85},0).wait(1).to({rotation:-125.568,x:-1662.95,y:257.6},0).wait(1).to({rotation:-126.624,x:-1665.25,y:255.45},0).wait(1).to({rotation:-127.711,x:-1667.6,y:253.35},0).wait(1).to({rotation:-128.833,x:-1669.95,y:251.35},0).wait(1).to({rotation:-129.988,x:-1672.3,y:249.4},0).wait(1).to({rotation:-131.178,x:-1674.7,y:247.55},0).wait(1).to({rotation:-132.404,x:-1677,y:245.75},0).wait(1).to({rotation:-133.665,x:-1679.4,y:244.1},0).wait(1).to({rotation:-134.963,x:-1681.8,y:242.4},0).wait(1).to({rotation:-136.297,x:-1684.15,y:240.9},0).wait(1).to({rotation:-137.667,x:-1686.45,y:239.45},0).wait(1).to({rotation:-139.075,x:-1688.85,y:238.05},0).wait(1).to({rotation:-140.518,x:-1691.25,y:236.7},0).wait(1).to({rotation:-141.998,x:-1693.7,y:235.5},0).wait(1).to({rotation:-143.513,x:-1696.15,y:234.35},0).wait(1).to({rotation:-145.063,x:-1698.5,y:233.25},0).wait(1).to({rotation:-146.646,x:-1700.9,y:232.2},0).wait(1).to({rotation:-148.261,x:-1703.35,y:231.35},0).wait(1).to({rotation:-149.907,x:-1705.75,y:230.5},0).wait(1).to({rotation:-151.582,x:-1708.2,y:229.7},0).wait(1).to({rotation:-153.284,x:-1710.65,y:229},0).wait(1).to({rotation:-155.009,x:-1713.1,y:228.4},0).wait(1).to({rotation:-156.757,x:-1715.55,y:227.85},0).wait(1).to({rotation:-158.524,x:-1717.95,y:227.45},0).wait(1).to({rotation:-160.307,x:-1720.45,y:227.05},0).wait(1).to({rotation:-162.102,x:-1722.9,y:226.75},0).wait(1).to({rotation:-163.907,x:-1725.4,y:226.5},0).wait(1).to({rotation:-165.718,x:-1727.85,y:226.35},0).wait(1).to({rotation:-167.532,x:-1730.3,y:226.3},0).wait(1).to({rotation:-169.344,x:-1732.75,y:226.35},0).wait(1).to({rotation:-171.153,x:-1735.2,y:226.45},0).wait(1).to({rotation:-172.953,x:-1737.7,y:226.55},0).wait(1).to({rotation:-174.741,x:-1740.15,y:226.85},0).wait(1).to({rotation:-176.515,x:-1742.55,y:227.2},0).wait(1).to({rotation:-178.272,x:-1745.05,y:227.55},0).wait(1).to({rotation:-180.007,x:-1747.5,y:228},0).wait(1).to({rotation:-181.72,x:-1749.95,y:228.55},0).wait(1).to({rotation:-183.407,x:-1752.4,y:229.2},0).wait(1).to({rotation:-185.065,x:-1754.85,y:229.9},0).wait(1).to({rotation:-186.694,x:-1757.3,y:230.7},0).wait(1).to({rotation:-188.291,x:-1759.8,y:231.55},0).wait(1).to({rotation:-189.856,x:-1762.3,y:232.45},0).wait(1).to({rotation:-191.386,x:-1764.7,y:233.45},0).wait(1).to({rotation:-192.881,x:-1767.1,y:234.55},0).wait(1).to({rotation:-194.34,x:-1769.6,y:235.65},0).wait(1).to({rotation:-195.763,x:-1772.05,y:236.9},0).wait(1).to({rotation:-197.15,x:-1774.5,y:238.2},0).wait(1).to({rotation:-198.5,x:-1776.95,y:239.55},0).wait(1).to({rotation:-199.813,x:-1779.35,y:241},0).wait(1).to({rotation:-201.09,x:-1781.85,y:242.5},0).wait(1).to({rotation:-202.331,x:-1784.25,y:244.1},0).wait(1).to({rotation:-203.536,x:-1786.7,y:245.75},0).wait(1).to({rotation:-204.706,x:-1789.15,y:247.5},0).wait(1).to({rotation:-205.842,x:-1791.6,y:249.25},0).wait(1).to({rotation:-206.944,x:-1794.05,y:251.15},0).wait(1).to({rotation:-208.013,x:-1796.5,y:253.1},0).wait(1).to({rotation:-209.05,x:-1798.95,y:255.15},0).wait(1).to({rotation:-210.056,x:-1801.45,y:257.25},0).wait(1).to({rotation:-211.031,x:-1803.85,y:259.4},0).wait(1).to({rotation:-211.977,x:-1806.35,y:261.7},0).wait(1).to({rotation:-212.894,x:-1808.8,y:264},0).wait(1).to({rotation:-213.783,x:-1811.3,y:266.4},0).wait(1).to({rotation:-214.645,x:-1813.75,y:268.9},0).wait(1).to({rotation:-215.481,x:-1816.25,y:271.45},0).wait(1).to({rotation:-216.292,x:-1818.75,y:274.1},0).wait(1).to({rotation:-217.079,x:-1821.25,y:276.75},0).wait(1).to({rotation:-217.842,x:-1823.75,y:279.6},0).wait(1).to({rotation:-218.583,x:-1826.2,y:282.45},0).wait(1).to({rotation:-219.301,x:-1828.7,y:285.45},0).wait(1).to({rotation:-219.999,x:-1831.25,y:288.45},0).wait(1).to({rotation:-220.676,x:-1833.75,y:291.55},0).wait(1).to({rotation:-221.334,x:-1836.3,y:294.8},0).wait(1).to({rotation:-221.972,x:-1838.85,y:298.05},0).wait(1).to({rotation:-222.593,x:-1841.35,y:301.45},0).wait(1).to({rotation:-223.196,x:-1844,y:304.9},0).wait(1).to({rotation:-223.782,x:-1846.55,y:308.4},0).wait(1).to({rotation:-224.352,x:-1849.05,y:312.05},0).wait(1).to({rotation:-224.906,x:-1851.65,y:315.75},0).wait(1).to({rotation:-225.445,x:-1854.25,y:319.6},0).wait(1).to({rotation:-225.97,x:-1856.85,y:323.5},0).wait(1).to({rotation:-226.481,x:-1859.5,y:327.45},0).wait(1).to({rotation:-226.978,x:-1862.1,y:331.55},0).wait(1).to({rotation:-227.462,x:-1864.7,y:335.7},0).wait(1).to({rotation:-227.933,x:-1867.4,y:340},0).wait(1).to({rotation:-228.393,x:-1870,y:344.35},0).wait(1).to({rotation:-228.841,x:-1872.65,y:348.8},0).wait(1).to({rotation:-229.277,x:-1875.35,y:353.4},0).wait(1).to({rotation:-229.703,x:-1878,y:357.95},0).wait(1).to({rotation:-230.118,x:-1880.75,y:362.75},0).wait(1).to({rotation:-230.524,x:-1883.45,y:367.6},0).wait(1).to({rotation:-230.919,x:-1886.15,y:372.6},0).wait(1).to({rotation:-231.306,x:-1888.95,y:377.65},0).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// trears_2
	this.instance = new lib.trears("synched",0);
	this.instance.setTransform(-1597.35,367.1,1,1,-105.0005,0,0,44,27.7);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(884).to({_off:false},0).wait(1).to({regX:48.8,regY:40.8,rotation:-105.601,x:-1589,y:354.45},0).wait(1).to({rotation:-106.228,x:-1592.2,y:349.95},0).wait(1).to({rotation:-106.864,x:-1595.3,y:345.5},0).wait(1).to({rotation:-107.51,x:-1598.5,y:341.25},0).wait(1).to({rotation:-108.165,x:-1601.65,y:337.05},0).wait(1).to({rotation:-108.829,x:-1604.85,y:332.85},0).wait(1).to({rotation:-109.504,x:-1608.05,y:328.85},0).wait(1).to({rotation:-110.188,x:-1611.25,y:324.8},0).wait(1).to({rotation:-110.882,x:-1614.45,y:320.95},0).wait(1).to({rotation:-111.585,x:-1617.65,y:317.15},0).wait(1).to({rotation:-112.299,x:-1620.85,y:313.45},0).wait(1).to({rotation:-113.023,x:-1624.15,y:309.85},0).wait(1).to({rotation:-113.757,x:-1627.35,y:306.3},0).wait(1).to({rotation:-114.501,x:-1630.6,y:302.85},0).wait(1).to({rotation:-115.255,x:-1633.85,y:299.4},0).wait(1).to({rotation:-116.02,x:-1637.2,y:296.1},0).wait(1).to({rotation:-116.794,x:-1640.5,y:292.85},0).wait(1).to({rotation:-117.579,x:-1643.8,y:289.7},0).wait(1).to({rotation:-118.374,x:-1647.1,y:286.6},0).wait(1).to({rotation:-119.179,x:-1650.45,y:283.6},0).wait(1).to({rotation:-119.994,x:-1653.75,y:280.7},0).wait(1).to({rotation:-120.819,x:-1657.1,y:277.8},0).wait(1).to({rotation:-121.654,x:-1660.45,y:275},0).wait(1).to({rotation:-122.498,x:-1663.85,y:272.3},0).wait(1).to({rotation:-123.352,x:-1667.25,y:269.65},0).wait(1).to({rotation:-124.216,x:-1670.65,y:267.05},0).wait(1).to({rotation:-125.089,x:-1674.05,y:264.55},0).wait(1).to({rotation:-125.971,x:-1677.5,y:262.15},0).wait(1).to({rotation:-126.861,x:-1680.9,y:259.8},0).wait(1).to({rotation:-127.761,x:-1684.4,y:257.45},0).wait(1).to({rotation:-128.668,x:-1687.85,y:255.25},0).wait(1).to({rotation:-129.584,x:-1691.35,y:253.1},0).wait(1).to({rotation:-130.508,x:-1694.85,y:251},0).wait(1).to({rotation:-131.439,x:-1698.35,y:248.95},0).wait(1).to({rotation:-132.378,x:-1701.85,y:247},0).wait(1).to({rotation:-133.323,x:-1705.4,y:245.1},0).wait(1).to({rotation:-134.274,x:-1708.95,y:243.3},0).wait(1).to({rotation:-135.232,x:-1712.5,y:241.6},0).wait(1).to({rotation:-136.195,x:-1716.1,y:239.85},0).wait(1).to({rotation:-137.163,x:-1719.7,y:238.25},0).wait(1).to({rotation:-138.136,x:-1723.3,y:236.7},0).wait(1).to({rotation:-139.113,x:-1726.95,y:235.2},0).wait(1).to({rotation:-140.094,x:-1730.65,y:233.8},0).wait(1).to({rotation:-141.078,x:-1734.2,y:232.45},0).wait(1).to({rotation:-142.066,x:-1737.9,y:231.1},0).wait(1).to({rotation:-143.055,x:-1741.65,y:229.9},0).wait(1).to({rotation:-144.046,x:-1745.3,y:228.75},0).wait(1).to({rotation:-145.038,x:-1749,y:227.65},0).wait(1).to({rotation:-146.031,x:-1752.75,y:226.65},0).wait(1).to({rotation:-147.024,x:-1756.55,y:225.7},0).wait(1).to({rotation:-148.017,x:-1760.3,y:224.8},0).wait(1).to({rotation:-149.009,x:-1764.05,y:223.95},0).wait(1).to({rotation:-150,x:-1767.85,y:223.2},0).wait(1).to({rotation:-150.988,x:-1771.65,y:222.5},0).wait(1).to({rotation:-151.974,x:-1775.5,y:221.85},0).wait(1).to({rotation:-152.957,x:-1779.3,y:221.3},0).wait(1).to({rotation:-153.937,x:-1783.15,y:220.8},0).wait(1).to({rotation:-154.913,x:-1787.05,y:220.35},0).wait(1).to({rotation:-155.884,x:-1790.95,y:219.95},0).wait(1).to({rotation:-156.851,x:-1794.75,y:219.65},0).wait(1).to({rotation:-157.812,x:-1798.75,y:219.4},0).wait(1).to({rotation:-158.767,x:-1802.65,y:219.25},0).wait(1).to({rotation:-159.716,x:-1806.55,y:219.15},0).wait(1).to({rotation:-160.659,x:-1810.55,y:219.1},0).wait(1).to({rotation:-161.594,x:-1814.5},0).wait(1).to({rotation:-162.522,x:-1818.5,y:219.2},0).wait(1).to({rotation:-163.443,x:-1822.5,y:219.35},0).wait(1).to({rotation:-164.356,x:-1826.55,y:219.55},0).wait(1).to({rotation:-165.26,x:-1830.55,y:219.85},0).wait(1).to({rotation:-166.156,x:-1834.65,y:220.15},0).wait(1).to({rotation:-167.043,x:-1838.7,y:220.55},0).wait(1).to({rotation:-167.921,x:-1842.75,y:221.05},0).wait(1).to({rotation:-168.79,x:-1846.85,y:221.55},0).wait(1).to({rotation:-169.65,x:-1851,y:222.15},0).wait(1).to({rotation:-170.5,x:-1855.2,y:222.85},0).wait(1).to({rotation:-171.34,x:-1859.35,y:223.55},0).wait(1).to({rotation:-172.171,x:-1863.55,y:224.4},0).wait(1).to({rotation:-172.991,x:-1867.7,y:225.25},0).wait(1).to({rotation:-173.801,x:-1871.9,y:226.2},0).wait(1).to({rotation:-174.602,x:-1876.15,y:227.2},0).wait(1).to({rotation:-175.392,x:-1880.4,y:228.25},0).wait(1).to({rotation:-176.172,x:-1884.75,y:229.4},0).wait(1).to({rotation:-176.941,x:-1889,y:230.55},0).wait(1).to({rotation:-177.7,x:-1893.3,y:231.85},0).wait(1).to({rotation:-178.449,x:-1897.7,y:233.2},0).wait(1).to({rotation:-179.188,x:-1902,y:234.55},0).wait(1).to({rotation:-179.917,x:-1906.4,y:236.1},0).wait(1).to({rotation:-180.635,x:-1910.8,y:237.6},0).wait(1).to({rotation:-181.343,x:-1915.25,y:239.2},0).wait(1).to({rotation:-182.041,x:-1919.65,y:240.95},0).wait(1).to({rotation:-182.729,x:-1924.2,y:242.65},0).wait(1).to({rotation:-183.407,x:-1928.65,y:244.5},0).wait(1).to({rotation:-184.075,x:-1933.2,y:246.4},0).wait(1).to({rotation:-184.734,x:-1937.75,y:248.4},0).wait(1).to({rotation:-185.383,x:-1942.35,y:250.5},0).wait(1).to({rotation:-186.022,x:-1947,y:252.55},0).wait(1).to({rotation:-186.651,x:-1951.6,y:254.8},0).wait(1).to({rotation:-187.272,x:-1956.25,y:257.1},0).wait(1).to({rotation:-187.883,x:-1960.95,y:259.4},0).wait(1).to({rotation:-188.485,x:-1965.65,y:261.85},0).wait(1).to({rotation:-189.078,x:-1970.45,y:264.35},0).wait(1).to({rotation:-189.663,x:-1975.2,y:266.95},0).wait(1).to({rotation:-190.238,x:-1980,y:269.6},0).wait(1).to({rotation:-190.805,x:-1984.9,y:272.35},0).wait(1).to({rotation:-191.364,x:-1989.8,y:275.2},0).wait(1).to({rotation:-191.914,x:-1994.7,y:278.1},0).wait(1).to({rotation:-192.456,x:-1999.65,y:281.15},0).wait(1).to({rotation:-192.991,x:-2004.65,y:284.2},0).wait(1).to({rotation:-193.517,x:-2009.7,y:287.4},0).wait(1).to({rotation:-194.036,x:-2014.8,y:290.65},0).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// sun2
	this.instance = new lib.sun2("synched",0);
	this.instance.setTransform(1634.25,-121.9,1.0161,0.4746,-120.0008,0,0,1794.7,1177);

	this.instance_1 = new lib.sun2("synched",0);
	this.instance_1.setTransform(-1150.6,66.5,0.9554,0.6285,-9.479,0,0,1794.9,1176.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1,p:{startPosition:0,scaleX:0.9554,scaleY:0.6285,rotation:-9.479,x:-1150.6,y:66.5}},{t:this.instance,p:{startPosition:0,regX:1794.7,regY:1177,scaleX:1.0161,scaleY:0.4746,rotation:-120.0008,x:1634.25,y:-121.9}}]}).to({state:[{t:this.instance_1,p:{startPosition:1,scaleX:0.9554,scaleY:0.6285,rotation:-9.479,x:-1150.6,y:66.5}},{t:this.instance,p:{startPosition:1,regX:1794.7,regY:1177,scaleX:1.0161,scaleY:0.4746,rotation:-120.0008,x:1634.25,y:-121.9}}]},1).to({state:[{t:this.instance_1,p:{startPosition:102,scaleX:0.9553,scaleY:0.6284,rotation:-9.4772,x:-1199.6,y:35}},{t:this.instance,p:{startPosition:102,regX:1794.6,regY:1177.1,scaleX:1.016,scaleY:0.4745,rotation:-120.0013,x:1585,y:-153.3}}]},323).to({state:[]},546).to({state:[{t:this.instance_1,p:{startPosition:99,scaleX:0.9553,scaleY:0.6284,rotation:-9.4772,x:-1199.6,y:35}},{t:this.instance,p:{startPosition:99,regX:1794.6,regY:1177.1,scaleX:1.016,scaleY:0.4745,rotation:-120.0013,x:1585,y:-153.3}}]},125).wait(232));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_4,p:{startPosition:0}},{t:this.instance_3,p:{startPosition:0}},{t:this.instance_2,p:{startPosition:0}},{t:this.instance_1,p:{startPosition:0}},{t:this.instance,p:{startPosition:0}}]}).to({state:[]},870).to({state:[{t:this.shape},{t:this.instance_4,p:{startPosition:42}},{t:this.instance_3,p:{startPosition:42}},{t:this.instance_2,p:{startPosition:42}},{t:this.instance_1,p:{startPosition:42}},{t:this.instance,p:{startPosition:42}}]},117).wait(240));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(870).to({_off:false},0).wait(125));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},607).to({state:[{t:this.instance_1}]},170).wait(93));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},995).to({state:[{t:this.instance_1}]},17).to({state:[{t:this.instance}]},88).wait(127));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.start}]}).to({state:[]},1).to({state:[{t:this.replay}]},1225).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-339.65,-899.15,0.6,0.6,0,0,0,-1838.2,769.2);

	this.instance_1 = new lib.bubbles2("synched",0);
	this.instance_1.setTransform(-529.45,-659.4,0.5,0.5,0,0,0,-1838.1,769.2);

	this.instance_2 = new lib.bubbles2("synched",0);
	this.instance_2.setTransform(-799.2,909.1,0.4,0.4,0,0,0,-1838.2,769.4);

	this.instance_3 = new lib.bubbles2("synched",0);
	this.instance_3.setTransform(2867.25,1128.9,0.3,0.3,0,0,0,-1838,769.4);

	this.instance_4 = new lib.bubbles2("synched",0);
	this.instance_4.setTransform(-2267.75,1048.95,0.2,0.2,0,0,0,-1838.3,769.5);

	this.instance_5 = new lib.bubbles2("synched",0);
	this.instance_5.setTransform(3476.65,369.6,1,1,0,0,0,109.9,109.9);

	this.instance_6 = new lib.bubbles1("synched",0);
	this.instance_6.setTransform(1078.95,-679.35,0.7,0.7,0,0,0,342.2,751.8);

	this.instance_7 = new lib.bubbles1("synched",0);
	this.instance_7.setTransform(179.85,-149.85,1,1,0,0,0,342.2,751.8);

	this.instance_8 = new lib.bubbles1("synched",0);
	this.instance_8.setTransform(1742.25,-442.6,0.6,0.6,0,0,0,342.2,751.8);

	this.instance_9 = new lib.bubbles1("synched",0);
	this.instance_9.setTransform(-1666.2,-732.85,0.5,0.5,0,0,0,342.2,751.7);

	this.instance_10 = new lib.bubbles1("synched",0);
	this.instance_10.setTransform(40,839.15,1,1,0,0,0,342.2,751.8);

	this.instance_11 = new lib.bubbles1("synched",0);
	this.instance_11.setTransform(859.2,0,1,1,0,0,0,342.2,751.8);

	this.instance_12 = new lib.bubbles1("synched",0);
	this.instance_12.setTransform(-1770,-693.3,1,1,0,0,0,342.2,751.8);

	this.instance_13 = new lib.bubbles1("synched",0);
	this.instance_13.setTransform(2877.2,-949.1,1,1,0,0,0,342.2,751.8);

	this.instance_14 = new lib.bubbles1("synched",0);
	this.instance_14.setTransform(2395.35,-822.4,0.55,0.55,0,0,0,342.2,751.8);

	this.instance_15 = new lib.bubbles1("synched",0);
	this.instance_15.setTransform(-2026,-1385.3,1,1,0,0,0,342.2,751.8);

	this.instance_16 = new lib.bubbles1("synched",0);
	this.instance_16.setTransform(-684.9,-1143.85,0.8,0.8564,0,0,0,342,751.7);

	this.instance_17 = new lib.bubbles1("synched",0);
	this.instance_17.setTransform(-1408.6,559.45,1,1,0,0,0,342.2,751.8);

	this.instance_18 = new lib.bubbles1("synched",0);
	this.instance_18.setTransform(-319.65,-509.5,1,1,0,0,0,342.2,751.8);

	this.instance_19 = new lib.bubbles1("synched",0);
	this.instance_19.setTransform(1528.6,-364.55,0.9,0.9,0,0,0,342.2,751.8);

	this.instance_20 = new lib.bubbles1("synched",0);
	this.instance_20.setTransform(-960.35,-159.7,0.6,0.6,0,0,0,342.2,751.8);

	this.instance_21 = new lib.bubbles1("synched",0);
	this.instance_21.setTransform(434.65,-984,1,1,0,0,0,82.5,82.5);

	this.instance_22 = new lib.bubbles1("synched",0);
	this.instance_22.setTransform(424.65,-1033.95,1,1,0,0,0,82.5,82.5);

	this.instance_23 = new lib.bubbles1("synched",0);
	this.instance_23.setTransform(1901.3,62.5,1,1,0,0,0,82.5,82.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_23,p:{startPosition:0}},{t:this.instance_22,p:{startPosition:0}},{t:this.instance_21,p:{startPosition:0}},{t:this.instance_20,p:{startPosition:0}},{t:this.instance_19,p:{startPosition:0}},{t:this.instance_18,p:{startPosition:0}},{t:this.instance_17,p:{startPosition:0}},{t:this.instance_16,p:{startPosition:0}},{t:this.instance_15,p:{startPosition:0}},{t:this.instance_14,p:{startPosition:0}},{t:this.instance_13,p:{startPosition:0}},{t:this.instance_12,p:{startPosition:0}},{t:this.instance_11,p:{startPosition:0}},{t:this.instance_10,p:{startPosition:0}},{t:this.instance_9,p:{startPosition:0}},{t:this.instance_8,p:{startPosition:0}},{t:this.instance_7,p:{startPosition:0}},{t:this.instance_6,p:{startPosition:0}},{t:this.instance_5,p:{startPosition:0}},{t:this.instance_4,p:{startPosition:0}},{t:this.instance_3,p:{startPosition:0}},{t:this.instance_2,p:{startPosition:0}},{t:this.instance_1,p:{startPosition:0}},{t:this.instance,p:{startPosition:0}}]}).to({state:[{t:this.instance_23,p:{startPosition:1}},{t:this.instance_22,p:{startPosition:1}},{t:this.instance_21,p:{startPosition:1}},{t:this.instance_20,p:{startPosition:1}},{t:this.instance_19,p:{startPosition:1}},{t:this.instance_18,p:{startPosition:1}},{t:this.instance_17,p:{startPosition:1}},{t:this.instance_16,p:{startPosition:1}},{t:this.instance_15,p:{startPosition:1}},{t:this.instance_14,p:{startPosition:1}},{t:this.instance_13,p:{startPosition:1}},{t:this.instance_12,p:{startPosition:1}},{t:this.instance_11,p:{startPosition:1}},{t:this.instance_10,p:{startPosition:1}},{t:this.instance_9,p:{startPosition:1}},{t:this.instance_8,p:{startPosition:1}},{t:this.instance_7,p:{startPosition:1}},{t:this.instance_6,p:{startPosition:1}},{t:this.instance_5,p:{startPosition:1}},{t:this.instance_4,p:{startPosition:1}},{t:this.instance_3,p:{startPosition:1}},{t:this.instance_2,p:{startPosition:1}},{t:this.instance_1,p:{startPosition:1}},{t:this.instance,p:{startPosition:1}}]},1).to({state:[]},869).to({state:[{t:this.instance_23,p:{startPosition:84}},{t:this.instance_22,p:{startPosition:84}},{t:this.instance_21,p:{startPosition:84}},{t:this.instance_20,p:{startPosition:84}},{t:this.instance_19,p:{startPosition:84}},{t:this.instance_18,p:{startPosition:84}},{t:this.instance_17,p:{startPosition:84}},{t:this.instance_16,p:{startPosition:84}},{t:this.instance_15,p:{startPosition:84}},{t:this.instance_14,p:{startPosition:84}},{t:this.instance_13,p:{startPosition:84}},{t:this.instance_12,p:{startPosition:84}},{t:this.instance_11,p:{startPosition:84}},{t:this.instance_10,p:{startPosition:84}},{t:this.instance_9,p:{startPosition:84}},{t:this.instance_8,p:{startPosition:84}},{t:this.instance_7,p:{startPosition:84}},{t:this.instance_6,p:{startPosition:84}},{t:this.instance_5,p:{startPosition:81}},{t:this.instance_4,p:{startPosition:81}},{t:this.instance_3,p:{startPosition:81}},{t:this.instance_2,p:{startPosition:81}},{t:this.instance_1,p:{startPosition:81}},{t:this.instance,p:{startPosition:81}}]},125).wait(232));
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFCCFF").s().p("");
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FF99FF").s().p("AhYG6IATtjIgTNjIlThAIgErNIAELNQhAgZg0gbQihhTgxhjQgSglALhWQAJhDAIgNQAphOBahOQAYgVA+grQBHgyAYgKQCDg+DngYQAUgDAVgBQCCgMBkgCQAggBAeADQA/AHA3AdQBeAxBHAyQDXCWADCfQADCXjpCJIAMpVIgMJVQheA3iDA0QiEAriqADIgfAAQggAAghgCgAD3F6IARszgAIXEjg");
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("rgba(0,0,0,0.839)").ss(3,1,1).p("");
	this.shape_8.setTransform(344.461,241.8604);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFCCFF").s().p("");
...
if (reversed == null) { reversed = false; }
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(0,0,0,0.839)").ss(3,1,1).p("");
	this.shape_3.setTransform(344.461,239.7604);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FF99FF").s().p("AhYG6IATtjIgTNjIlThAIgErNIAELNQhAgZg0gbQihhTgxhjQgSglALhWQAJhDAIgNQAphOBahOQAYgVA+grQBHgyAYgKQCDg+DngYQAUgDAVgBQCCgMBkgCQAggBAeADQA/AHA3AdQBeAxBHAyQDXCWADCfQADCXjpCJIAMpVIgMJVQheA3iDA0QiEAriqADIgfAAQghAAgggCgAD3F6IARszgAIXEjg");
	this.shape_4.setTransform(462.5815,215.0275);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFCCFF").s().p("");
	this.shape_5.setTransform(344.461,239.7604);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("rgba(0,0,0,0.839)").ss(3,1,1).p("");
	this.shape_6.setTransform(344.461,233.4604);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FF99FF").s().p("AhYG6IATtjQAUgDAVgBQCCgMBkgCQAggBAeADQA/AHA3AdQBeAxBHAyIgMJVQheA3iDA0QiEAriqADIgfAAQghAAgggCgAD3F6IARszgAmrF6IgErNIAELNQhAgZg0gbQihhTgxhjQgSglALhWQAJhDAIgNQAphOBahOQAYgVA+grQBHgyAYgKQCDg+DngYIgTNjgAIXEjgAIjkyQDXCWADCfQADCXjpCJgAhFmpg");
	this.shape_7.setTransform(462.5815,208.7275);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FF99FF").s().p("AhYG6IATtjQAUgDAVgBQCCgMBkgCQAggBAeADQA/AHA3AdQBeAxBHAyIgMJVQheA3iDA0QiEAriqADIgfAAQggAAghgCgAD3F6IARszgAmrF6IgErNIAELNQhAgZg0gbQihhTgxhjQgSglALhWQAJhDAIgNQAphOBahOQAYgVA+grQBHgyAYgKQCDg+DngYIgTNjgAIXEjgAIjkyQDXCWADCfQADCXjpCJgAhFmpg");
	this.shape_8.setTransform(462.5815,206.6275);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FF99FF").s().p("AhYG6IATtjIgTNjIlThAIgErNIAELNQhAgZg0gbQihhTgxhjQgSglALhWQAJhDAIgNQAphOBahOQAYgVA+grQBHgyAYgKQCDg+DngYQAUgDAVgBQCCgMBkgCQAggBAeADQA/AHA3AdQBeAxBHAyQDXCWADCfQADCXjpCJIAMpVIgMJVQheA3iDA0QiEAriqADIgfAAQggAAghgCgAD3F6IARszgAIXEjg");
	this.shape_9.setTransform(462.5815,204.5275);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2,p:{y:241.8604}},{t:this.shape_1,p:{y:217.1275}},{t:this.shape,p:{y:241.8604}},{t:this.instance,p:{y:-39.75}}]}).to({state:[{t:this.shape_5,p:{y:239.7604}},{t:this.shape_4},{t:this.shape_3,p:{y:239.7604}},{t:this.instance,p:{y:-41.85}}]},3).to({state:[{t:this.shape_2,p:{y:237.6604}},{t:this.shape_1,p:{y:212.9275}},{t:this.shape,p:{y:237.6604}},{t:this.instance,p:{y:-43.95}}]},3).to({state:[{t:this.shape_2,p:{y:235.5604}},{t:this.shape_1,p:{y:210.8275}},{t:this.shape,p:{y:235.5604}},{t:this.instance,p:{y:-46.05}}]},3).to({state:[{t:this.shape_5,p:{y:233.4604}},{t:this.shape_7},{t:this.shape_6,p:{y:233.4604}},{t:this.instance,p:{y:-48.15}}]},3).to({state:[{t:this.shape_5,p:{y:231.3604}},{t:this.shape_8},{t:this.shape_6,p:{y:231.3604}},{t:this.instance,p:{y:-50.25}}]},3).to({state:[{t:this.shape_5,p:{y:229.2604}},{t:this.shape_9},{t:this.shape_3,p:{y:229.2604}},{t:this.instance,p:{y:-52.35}}]},3).to({state:[{t:this.shape_5,p:{y:227.1604}},{t:this.shape_11},{t:this.shape_10},{t:this.instance,p:{y:-54.45}}]},3).to({state:[{t:this.shape_5,p:{y:227.1604}},{t:this.shape_11},{t:this.shape_10},{t:this.instance,p:{y:-54.45}}]},3).to({state:[{t:this.shape_5,p:{y:229.2604}},{t:this.shape_9},{t:this.shape_3,p:{y:229.2604}},{t:this.instance,p:{y:-52.35}}]},3).to({state:[{t:this.shape_5,p:{y:231.3604}},{t:this.shape_8},{t:this.shape_6,p:{y:231.3604}},{t:this.instance,p:{y:-50.25}}]},3).to({state:[{t:this.shape_5,p:{y:233.4604}},{t:this.shape_7},{t:this.shape_6,p:{y:233.4604}},{t:this.instance,p:{y:-48.15}}]},3).to({state:[{t:this.shape_2,p:{y:235.5604}},{t:this.shape_1,p:{y:210.8275}},{t:this.shape,p:{y:235.5604}},{t:this.instance,p:{y:-46.05}}]},3).to({state:[{t:this.shape_2,p:{y:237.6604}},{t:this.shape_1,p:{y:212.9275}},{t:this.shape,p:{y:237.6604}},{t:this.instance,p:{y:-43.95}}]},3).to({state:[{t:this.shape_5,p:{y:239.7604}},{t:this.shape_4},{t:this.shape_3,p:{y:239.7604}},{t:this.instance,p:{y:-41.85}}]},3).to({state:[{t:this.shape_2,p:{y:241.8604}},{t:this.shape_1,p:{y:217.1275}},{t:this.shape,p:{y:241.8604}},{t:this.instance,p:{y:-39.75}}]},3).wait(3));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(206.85,421.6,1,1,0,0,0,127,120.3);
	...
	this.shape_8.setTransform(343.4418,305.4219);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FF99FF").s().p("Ag6G7IATtjIgTNjIlThAIgErOQCDg9DngYQAUgDAUgCQCDgLBlABQBhgIBPAGIAKAAIhPNIQiEAqiqADIggABQggAAgggCgAFUGPgAGjm5QFDAZADEIQABCmhjCuIigCOQhDAqhQAbgArPgvQAohUBhhUQAwgpApgaQAjgfA5gaIAELOQm3itB1j9gAmRlTg");
	this.shape_9.setTransform(457.5445,349.5759);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("rgba(0,0,0,0.839)").ss(3,1,1).p("");
	this.shape_10.setTransform(343.4418,301.8219);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FF99FF").s().p("Ag6G7IATtjQAUgDAUgCQCDgLBlABQBhgIBPAGIAKAAIhPNIQiEAqiqADIggABQggAAgggCgAmNF7IgErOIAELOQm3itB1j9QAohUBhhUQAwgpApgaQAjgfA5gaQCDg9DngYIgTNjgAFUGPgAGjm5QFDAZADEIQABCmhjCuIigCOQhDAqhQAbg");
	this.shape_11.setTransform(457.5445,345.9759);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("rgba(0,0,0,0.839)").ss(3,1,1).p("");
	this.shape_12.setTransform(343.4418,303.6219);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FF99FF").s().p("Ag6G7IATtjIgTNjIlThAIgErOIAELOQm3itB1j9QAohUBhhUQAwgpApgaQAjgfA5gaQCDg9DngYQAUgDAUgCQCDgLBlABQBhgIBPAGIAKAAIhPNIQiEAqiqADIggABQggAAgggCgAFUGPgAGjm5QFDAZADEIQABCmhjCuIigCOQhDAqhQAbg");
	this.shape_13.setTransform(457.5445,347.7759);
	...
	this.shape_16.setTransform(343.4418,310.8219);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5,p:{y:379.7645}},{t:this.shape_4,p:{y:125.2577}},{t:this.shape_3,p:{y:126.625}},{t:this.shape_2,p:{y:354.9759}},{t:this.shape_1,p:{y:310.8219}},{t:this.shape,p:{y:-21.4673}},{t:this.instance,p:{y:421.6}}]}).to({state:[{t:this.shape_4,p:{y:123.4577}},{t:this.shape_3,p:{y:124.825}},{t:this.shape_6},{t:this.shape_2,p:{y:353.1759}},{t:this.shape,p:{y:-23.2673}},{t:this.shape_1,p:{y:309.0219}},{t:this.instance,p:{y:419.8}}]},4).to({state:[{t:this.shape_4,p:{y:125.2577}},{t:this.shape_3,p:{y:126.625}},{t:this.shape_5,p:{y:379.7645}},{t:this.shape_2,p:{y:354.9759}},{t:this.shape,p:{y:-21.4673}},{t:this.shape_1,p:{y:310.8219}},{t:this.instance,p:{y:421.6}}]},3).to({state:[{t:this.shape_4,p:{y:123.4577}},{t:this.shape_3,p:{y:124.825}},{t:this.shape_6},{t:this.shape_2,p:{y:353.1759}},{t:this.shape,p:{y:-23.2673}},{t:this.shape_1,p:{y:309.0219}},{t:this.instance,p:{y:419.8}}]},3).to({state:[{t:this.shape_4,p:{y:121.6577}},{t:this.shape_3,p:{y:123.025}},{t:this.shape_5,p:{y:376.1645}},{t:this.shape_2,p:{y:351.3759}},{t:this.shape,p:{y:-25.0673}},{t:this.shape_7},{t:this.instance,p:{y:418}}]},3).to({state:[{t:this.shape_4,p:{y:119.8577}},{t:this.shape_3,p:{y:121.225}},{t:this.shape_5,p:{y:374.3645}},{t:this.shape_9,p:{y:349.5759}},{t:this.shape,p:{y:-26.8673}},{t:this.shape_8,p:{y:305.4219}},{t:this.instance,p:{y:416.2}}]},3).to({state:[{t:this.shape_4,p:{y:118.0577}},{t:this.shape_3,p:{y:119.425}},{t:this.shape_5,p:{y:372.5645}},{t:this.shape_9,p:{y:347.7759}},{t:this.shape,p:{y:-28.6673}},{t:this.shape_8,p:{y:303.6219}},{t:this.instance,p:{y:414.4}}]},4).to({state:[{t:this.shape_4,p:{y:116.2577}},{t:this.shape_3,p:{y:117.625}},{t:this.shape_5,p:{y:370.7645}},{t:this.shape_11,p:{y:345.9759}},{t:this.shape,p:{y:-30.4673}},{t:this.shape_10},{t:this.instance,p:{y:412.6}}]},4).to({state:[{t:this.shape_4,p:{y:118.0577}},{t:this.shape_3,p:{y:119.425}},{t:this.shape_5,p:{y:372.5645}},{t:this.shape_13,p:{y:347.7759}},{t:this.shape,p:{y:-28.6673}},{t:this.shape_12,p:{y:303.6219}},{t:this.instance,p:{y:414.4}}]},4).to({state:[{t:this.shape_4,p:{y:119.8577}},{t:this.shape_3,p:{y:121.225}},{t:this.shape_5,p:{y:374.3645}},{t:this.shape_13,p:{y:349.5759}},{t:this.shape,p:{y:-26.8673}},{t:this.shape_12,p:{y:305.4219}},{t:this.instance,p:{y:416.2}}]},4).to({state:[{t:this.shape_4,p:{y:121.6577}},{t:this.shape_3,p:{y:123.025}},{t:this.shape_5,p:{y:376.1645}},{t:this.shape_11,p:{y:351.3759}},{t:this.shape,p:{y:-25.0673}},{t:this.shape_14},{t:this.instance,p:{y:418}}]},4).to({state:[{t:this.shape_4,p:{y:123.4577}},{t:this.shape_3,p:{y:124.825}},{t:this.shape_6},{t:this.shape_2,p:{y:353.1759}},{t:this.shape,p:{y:-23.2673}},{t:this.shape_15},{t:this.instance,p:{y:419.8}}]},3).to({state:[{t:this.shape_4,p:{y:125.2577}},{t:this.shape_3,p:{y:126.625}},{t:this.shape_5,p:{y:379.7645}},{t:this.shape_2,p:{y:354.9759}},{t:this.shape,p:{y:-21.4673}},{t:this.shape_16},{t:this.instance,p:{y:421.6}}]},3).wait(3));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-127.5,152.55,1,1,0,0,0,127,120);
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(0,0,0,0.839)").ss(3,1,1).p("");
	this.shape_1.setTransform(0.5418,36.4719);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFCCFF").s().p("");
	this.shape_2.setTransform(0.5418,105.4145);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FF99FF").s().p("Ag6G7IATtjQAUgDAUgCQCDgLBlABQBhgIBPAGIAKAAQFDAZADEIQABCmhjCuIigCOQhDAqhQAbIBPtIIhPNIQiEAqiqADIggABQggAAgggCgAg6G7IlThAIgErOQCDg9DngYIgTNjIAAAAgAFUGPgArPgvQAohUBhhUQAwgpApgaQAjgfA5gaIAELOQm3itB1j9gAmRlTg");
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7,p:{y:319.5796}},{t:this.shape_6,p:{y:420.543}},{t:this.shape_5,p:{y:148.0475}},{t:this.shape_4,p:{y:125.8321}},{t:this.shape_3,p:{y:319.5796}},{t:this.shape_2,p:{y:420.543}},{t:this.shape_1,p:{y:125.8321}},{t:this.shape,p:{y:108.1636}},{t:this.instance,p:{y:379.65}}]}).to({state:[{t:this.shape_7,p:{y:318.1796}},{t:this.shape_6,p:{y:419.143}},{t:this.shape_5,p:{y:146.6475}},{t:this.shape_4,p:{y:124.4321}},{t:this.shape_3,p:{y:318.1796}},{t:this.shape_2,p:{y:419.143}},{t:this.shape_1,p:{y:124.4321}},{t:this.shape,p:{y:106.7636}},{t:this.instance,p:{y:378.25}}]},4).to({state:[{t:this.shape_7,p:{y:316.7796}},{t:this.shape_6,p:{y:417.743}},{t:this.shape_5,p:{y:145.2475}},{t:this.shape_4,p:{y:123.0321}},{t:this.shape_3,p:{y:316.7796}},{t:this.shape_2,p:{y:417.743}},{t:this.shape_1,p:{y:123.0321}},{t:this.shape,p:{y:105.3636}},{t:this.instance,p:{y:376.85}}]},4).to({state:[{t:this.shape_7,p:{y:315.3796}},{t:this.shape_6,p:{y:416.343}},{t:this.shape_5,p:{y:143.8475}},{t:this.shape_4,p:{y:121.6321}},{t:this.shape_3,p:{y:315.3796}},{t:this.shape_2,p:{y:416.343}},{t:this.shape_1,p:{y:121.6321}},{t:this.shape,p:{y:103.9636}},{t:this.instance,p:{y:375.45}}]},4).to({state:[{t:this.shape_7,p:{y:313.9796}},{t:this.shape_6,p:{y:414.943}},{t:this.shape_5,p:{y:142.4475}},{t:this.shape_4,p:{y:120.2321}},{t:this.shape_3,p:{y:313.9796}},{t:this.shape_2,p:{y:414.943}},{t:this.shape_1,p:{y:120.2321}},{t:this.shape,p:{y:102.5636}},{t:this.instance,p:{y:374.05}}]},4).to({state:[{t:this.shape_7,p:{y:312.5796}},{t:this.shape_6,p:{y:413.543}},{t:this.shape_5,p:{y:141.0475}},{t:this.shape_4,p:{y:118.8321}},{t:this.shape_3,p:{y:312.5796}},{t:this.shape_2,p:{y:413.543}},{t:this.shape_1,p:{y:118.8321}},{t:this.shape,p:{y:101.1636}},{t:this.instance,p:{y:372.65}}]},4).to({state:[{t:this.shape_7,p:{y:311.1796}},{t:this.shape_6,p:{y:412.143}},{t:this.shape_5,p:{y:139.6475}},{t:this.shape_4,p:{y:117.4321}},{t:this.shape_3,p:{y:311.1796}},{t:this.shape_2,p:{y:412.143}},{t:this.shape_1,p:{y:117.4321}},{t:this.shape,p:{y:99.7636}},{t:this.instance,p:{y:371.25}}]},5).to({state:[{t:this.shape_7,p:{y:309.7796}},{t:this.shape_6,p:{y:410.743}},{t:this.shape_5,p:{y:138.2475}},{t:this.shape_4,p:{y:116.0321}},{t:this.shape_3,p:{y:309.7796}},{t:this.shape_2,p:{y:410.743}},{t:this.shape_1,p:{y:116.0321}},{t:this.shape,p:{y:98.3636}},{t:this.instance,p:{y:369.85}}]},4).to({state:[{t:this.shape_7,p:{y:308.3796}},{t:this.shape_6,p:{y:409.343}},{t:this.shape_5,p:{y:136.8475}},{t:this.shape_4,p:{y:114.6321}},{t:this.shape_3,p:{y:308.3796}},{t:this.shape_2,p:{y:409.343}},{t:this.shape_1,p:{y:114.6321}},{t:this.shape,p:{y:96.9636}},{t:this.instance,p:{y:368.45}}]},4).to({state:[{t:this.shape_7,p:{y:306.9796}},{t:this.shape_6,p:{y:407.943}},{t:this.shape_5,p:{y:135.4475}},{t:this.shape_4,p:{y:113.2321}},{t:this.shape_3,p:{y:306.9796}},{t:this.shape_2,p:{y:407.943}},{t:this.shape_1,p:{y:113.2321}},{t:this.shape,p:{y:95.5636}},{t:this.instance,p:{y:367.05}}]},4).to({state:[{t:this.shape_7,p:{y:308.3796}},{t:this.shape_6,p:{y:409.343}},{t:this.shape_5,p:{y:136.8475}},{t:this.shape_4,p:{y:114.6321}},{t:this.shape_3,p:{y:308.3796}},{t:this.shape_2,p:{y:409.343}},{t:this.shape_1,p:{y:114.6321}},{t:this.shape,p:{y:96.9636}},{t:this.instance,p:{y:368.45}}]},5).to({state:[{t:this.shape_7,p:{y:309.7796}},{t:this.shape_6,p:{y:410.743}},{t:this.shape_5,p:{y:138.2475}},{t:this.shape_4,p:{y:116.0321}},{t:this.shape_3,p:{y:309.7796}},{t:this.shape_2,p:{y:410.743}},{t:this.shape_1,p:{y:116.0321}},{t:this.shape,p:{y:98.3636}},{t:this.instance,p:{y:369.85}}]},4).to({state:[{t:this.shape_7,p:{y:311.1796}},{t:this.shape_6,p:{y:412.143}},{t:this.shape_5,p:{y:139.6475}},{t:this.shape_4,p:{y:117.4321}},{t:this.shape_3,p:{y:311.1796}},{t:this.shape_2,p:{y:412.143}},{t:this.shape_1,p:{y:117.4321}},{t:this.shape,p:{y:99.7636}},{t:this.instance,p:{y:371.25}}]},4).to({state:[{t:this.shape_7,p:{y:312.5796}},{t:this.shape_6,p:{y:413.543}},{t:this.shape_5,p:{y:141.0475}},{t:this.shape_4,p:{y:118.8321}},{t:this.shape_3,p:{y:312.5796}},{t:this.shape_2,p:{y:413.543}},{t:this.shape_1,p:{y:118.8321}},{t:this.shape,p:{y:101.1636}},{t:this.instance,p:{y:372.65}}]},4).to({state:[{t:this.shape_7,p:{y:313.9796}},{t:this.shape_6,p:{y:414.943}},{t:this.shape_5,p:{y:142.4475}},{t:this.shape_4,p:{y:120.2321}},{t:this.shape_3,p:{y:313.9796}},{t:this.shape_2,p:{y:414.943}},{t:this.shape_1,p:{y:120.2321}},{t:this.shape,p:{y:102.5636}},{t:this.instance,p:{y:374.05}}]},5).to({state:[{t:this.shape_7,p:{y:315.3796}},{t:this.shape_6,p:{y:416.343}},{t:this.shape_5,p:{y:143.8475}},{t:this.shape_4,p:{y:121.6321}},{t:this.shape_3,p:{y:315.3796}},{t:this.shape_2,p:{y:416.343}},{t:this.shape_1,p:{y:121.6321}},{t:this.shape,p:{y:103.9636}},{t:this.instance,p:{y:375.45}}]},4).to({state:[{t:this.shape_7,p:{y:316.7796}},{t:this.shape_6,p:{y:417.743}},{t:this.shape_5,p:{y:145.2475}},{t:this.shape_4,p:{y:123.0321}},{t:this.shape_3,p:{y:316.7796}},{t:this.shape_2,p:{y:417.743}},{t:this.shape_1,p:{y:123.0321}},{t:this.shape,p:{y:105.3636}},{t:this.instance,p:{y:376.85}}]},4).to({state:[{t:this.shape_7,p:{y:318.1796}},{t:this.shape_6,p:{y:419.143}},{t:this.shape_5,p:{y:146.6475}},{t:this.shape_4,p:{y:124.4321}},{t:this.shape_3,p:{y:318.1796}},{t:this.shape_2,p:{y:419.143}},{t:this.shape_1,p:{y:124.4321}},{t:this.shape,p:{y:106.7636}},{t:this.instance,p:{y:378.25}}]},4).wait(4));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1.5,-14.1,849.3,654.8000000000001);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},339).to({state:[{t:this.instance_1,p:{regX:343.5,regY:274.7,scaleX:0.7,scaleY:0.7,x:2103.3,y:1563.05}}]},22).to({state:[{t:this.instance_2}]},5).to({state:[{t:this.instance_1,p:{regX:0.6,regY:8.8,scaleX:0.75,scaleY:0.75,x:1853.7,y:1381.85}}]},123).wait(34));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},995).to({state:[{t:this.instance_1}]},105).wait(127));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(287).to({_off:false},0).wait(52));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(488).to({_off:false},0).wait(1).to({regX:423.1,regY:313.3,x:3230.05,y:1865.3},0).wait(1).to({x:3221.2,y:1880},0).wait(1).to({x:3212.25,y:1893.3},0).wait(1).to({x:3203.25,y:1905.4},0).wait(1).to({x:3194.15,y:1916.3},0).wait(1).to({x:3185,y:1926.05},0).wait(1).to({x:3175.7,y:1934.75},0).wait(1).to({x:3166.35,y:1942.4},0).wait(1).to({x:3156.9,y:1949.1},0).wait(1).to({x:3147.4,y:1954.85},0).wait(1).to({x:3137.75,y:1959.65},0).wait(1).to({x:3128,y:1963.55},0).wait(1).to({x:3118.1,y:1966.6},0).wait(1).to({x:3108.15,y:1968.85},0).wait(1).to({x:3098.05,y:1970.2},0).wait(1).to({x:3087.8,y:1970.75},0).wait(1).to({x:3077.45,y:1970.55},0).wait(1).to({x:3066.95,y:1969.5},0).wait(1).to({x:3056.35,y:1967.7},0).wait(1).to({x:3045.55,y:1965.05},0).wait(1).to({x:3034.65,y:1961.7},0).wait(1).to({x:3023.55,y:1957.55},0).wait(1).to({x:3012.3,y:1952.6},0).wait(1).to({x:3000.9,y:1946.9},0).wait(1).to({x:2989.3,y:1940.4},0).wait(1).to({x:2977.5,y:1933.1},0).wait(1).to({x:2965.55,y:1925.05},0).wait(1).to({x:2953.35,y:1916.15},0).wait(1).to({x:2941,y:1906.45},0).wait(1).to({x:2928.35,y:1895.9},0).wait(1).to({x:2915.55,y:1884.5},0).wait(1).to({x:2902.45,y:1872.25},0).wait(1).to({x:2889.1,y:1859.1},0).wait(1).to({x:2875.5,y:1845},0).wait(1).to({x:2861.6,y:1830},0).wait(1).to({x:2847.4,y:1813.95},0).wait(1).to({x:2832.85,y:1796.95},0).wait(1).to({x:2818,y:1778.85},0).wait(1).to({x:2802.75,y:1759.65},0).wait(1).to({x:2787.15,y:1739.25},0).wait(1).to({x:2771.1,y:1717.65},0).wait(1).to({x:2754.65,y:1694.75},0).wait(1).to({x:2737.65,y:1670.5},0).wait(1).to({x:2720.2,y:1644.75},0).wait(1).to({x:2702.1,y:1617.4},0).wait(1).to({x:2683.4,y:1588.35},0).wait(1).to({regX:423.2,regY:319.8,x:2683.45,y:1590.95},0).wait(30).to({regY:319.7},0).wait(1).to({regX:423.1,regY:313.3,x:2677.35,y:1577.45},0).wait(1).to({x:2670.9,y:1566.75},0).wait(1).to({x:2664.1,y:1556.4},0).wait(1).to({x:2656.9,y:1546.3},0).wait(1).to({x:2649.3,y:1536.45},0).wait(1).to({x:2641.4,y:1526.9},0).wait(1).to({x:2633.1,y:1517.6},0).wait(1).to({x:2624.45,y:1508.55},0).wait(1).to({x:2615.45,y:1499.7},0).wait(1).to({x:2606.1,y:1491.15},0).wait(1).to({x:2596.45,y:1482.85},0).wait(1).to({x:2586.4,y:1474.75},0).wait(1).to({x:2576.05,y:1466.85},0).wait(1).to({x:2565.4,y:1459.2},0).wait(1).to({x:2554.35,y:1451.8},0).wait(1).to({x:2543.05,y:1444.6},0).wait(1).to({x:2531.35,y:1437.6},0).wait(1).to({x:2519.4,y:1430.85},0).wait(1).to({x:2507.1,y:1424.3},0).wait(1).to({x:2494.45,y:1417.95},0).wait(1).to({x:2481.55,y:1411.75},0).wait(1).to({x:2468.3,y:1405.8},0).wait(1).to({x:2454.75,y:1400.05},0).wait(1).to({x:2440.85,y:1394.5},0).wait(1).to({x:2426.65,y:1389.15},0).wait(1).to({x:2412.2,y:1383.95},0).wait(1).to({x:2397.35,y:1379},0).wait(1).to({x:2382.25,y:1374.2},0).wait(1).to({x:2366.85,y:1369.55},0).wait(1).to({x:2351.1,y:1365.15},0).wait(1).to({x:2335.1,y:1360.9},0).wait(1).to({x:2318.75,y:1356.85},0).wait(1).to({x:2302.1,y:1352.95},0).wait(1).to({x:2285.15,y:1349.25},0).wait(1).to({x:2267.9,y:1345.7},0).wait(1).to({x:2250.35,y:1342.35},0).wait(1).to({x:2232.45,y:1339.2},0).wait(1).to({x:2214.25,y:1336.2},0).wait(1).to({x:2195.75,y:1333.35},0).wait(1).to({x:2176.95,y:1330.7},0).wait(1).to({x:2157.85,y:1328.2},0).wait(1).to({x:2138.45,y:1325.9},0).wait(1).to({x:2118.7,y:1323.75},0).wait(1).to({x:2098.65,y:1321.75},0).wait(1).to({x:2078.25,y:1319.95},0).wait(1).to({x:2057.6,y:1318.3},0).wait(1).to({x:2036.55,y:1316.85},0).wait(1).to({x:2015.25,y:1315.55},0).wait(1).to({x:1993.6,y:1314.4},0).wait(1).to({x:1971.6,y:1313.4},0).wait(1).to({x:1949.3,y:1312.6},0).wait(1).to({x:1926.65,y:1312},0).wait(1).to({x:1903.7,y:1311.5},0).wait(1).to({x:1880.4,y:1311.2},0).wait(1).to({x:1856.75,y:1311.1},0).wait(1).to({x:1832.8},0).wait(1).to({x:1808.45,y:1311.3},0).wait(1).to({x:1783.8,y:1311.7},0).wait(1).to({x:1758.8,y:1312.2},0).wait(1).to({x:1733.4,y:1312.95},0).wait(1).to({x:1707.7,y:1313.8},0).wait(1).to({x:1681.6,y:1314.85},0).wait(1).to({x:1655.15,y:1316.1},0).wait(1).to({x:1628.35,y:1317.5},0).wait(1).to({x:1601.15,y:1319.05},0).wait(1).to({x:1573.6,y:1320.8},0).wait(1).to({x:1545.65,y:1322.7},0).wait(1).to({x:1517.3,y:1324.8},0).wait(1).to({x:1488.6,y:1327.05},0).wait(1).to({x:1459.45,y:1329.5},0).wait(1).to({x:1429.95,y:1332.15},0).wait(1).to({x:1400,y:1334.95},0).wait(1).to({x:1369.65,y:1337.95},0).wait(1).to({x:1338.9,y:1341.1},0).wait(1).to({x:1307.7,y:1344.5},0).wait(1).to({x:1276.1,y:1348.05},0).wait(1).to({x:1244,y:1351.75},0).wait(1).to({x:1211.5,y:1355.7},0).wait(1).to({x:1178.5,y:1359.85},0).wait(1).to({x:1145.1,y:1364.15},0).wait(1).to({x:1111.2,y:1368.7},0).wait(1).to({x:1076.8,y:1373.4},0).wait(1).to({x:1041.9,y:1378.35},0).wait(1).to({x:1006.55,y:1383.45},0).wait(1).to({x:970.65,y:1388.8},0).wait(1).to({x:934.25,y:1394.4},0).wait(1).to({x:897.3,y:1400.15},0).wait(1).to({x:859.8,y:1406.15},0).wait(1).to({x:821.8,y:1412.4},0).wait(1).to({x:783.2,y:1418.85},0).wait(1).to({x:744,y:1425.5},0).wait(1).to({x:704.25,y:1432.45},0).wait(1).to({x:663.85,y:1439.6},0).wait(1).to({x:622.85,y:1447},0).wait(1).to({x:581.2,y:1454.65},0).wait(1).to({x:538.85,y:1462.6},0).wait(1).to({x:495.9,y:1470.75},0).wait(1).to({x:452.2,y:1479.2},0).wait(1).to({x:407.8,y:1487.9},0).wait(1).to({regX:423.2,regY:319.8,x:407.85,y:1490.55},0).wait(205));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance,p:{regX:423.2,regY:319.8,scaleX:0.4,scaleY:0.4,x:407.85,y:1490.55}}]},995).to({state:[{t:this.instance_1,p:{regX:424,regY:320.2,scaleX:0.3999,scaleY:0.3999,x:407.7,y:1490.9}}]},119).to({state:[{t:this.instance_1,p:{regX:423.2,regY:319.5,scaleX:0.4,scaleY:0.4,x:407.9,y:1490.45}},{t:this.instance,p:{regX:423.7,regY:320.2,scaleX:0.3999,scaleY:0.3999,x:407.95,y:1490.85}}]},89).wait(24));
...
// stage content:
(lib.myAnimation = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.actionFrames = [0,1,82,295,366,674,793,870,1012,1114,1226];
	...
	this.frame_1 = function() {
		...
		playSound("MovieFreakySceneSoundBiblecom498428129mp3copy");
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(81).call(this.frame_82).wait(213).call(this.frame_295).wait(71).call(this.frame_366).wait(308).call(this.frame_674).wait(119).call(this.frame_793).wait(77).call(this.frame_870).wait(142).call(this.frame_1012).wait(102).call(this.frame_1114).wait(112).call(this.frame_1226).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.buttoms).wait(1226).to({regX:538.4,regY:2572.3,scaleX:0.5529,scaleY:0.5529,y:1037.9},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.sun2).wait(324).to({regX:484.7,regY:642.2,scaleX:0.6224,scaleY:0.6224},0).wait(546).to({regX:-2332.7,regY:-314,scaleX:0.6048,scaleY:0.6048},0).wait(125).to({regX:-1435.7,regY:185.7,scaleX:0.5017,scaleY:0.5017},0).wait(232));

	// bubbles1_obj_
	this.bubbles1 = new lib.Scene_1_bubbles1();
	this.bubbles1.name = "bubbles1";
	this.bubbles1.setTransform(589.4,622.3,0.3437,0.3437,0,0,0,987.2,1726.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.bubbles1).wait(870).to({regX:-1412.4,regY:916.6,scaleX:0.6048,scaleY:0.6048,x:589.45,y:622.25},0).wait(125).to({regX:-326.3,regY:1669.2,scaleX:0.5017,scaleY:0.5017,y:622.3},0).wait(232));
	...
	this.timeline.addTween(cjs.Tween.get(this.charly).wait(995).to({regX:-1501.2,regY:428.8,scaleX:0.5017,scaleY:0.5017,x:0.05},0).wait(119).to({regX:-1604,regY:695.1,scaleX:0.5529,scaleY:0.5529,x:0,y:-0.05},0).wait(113));
	...
	this.timeline.addTween(cjs.Tween.get(this.fish2).wait(995).to({regX:-1501.2,regY:428.8,scaleX:0.5017,scaleY:0.5017,x:0.05},0).wait(17).to({regX:-1774,regY:905.5,scaleX:1.0035,scaleY:1.0035,x:-0.05,y:0.05},0).wait(88).to({regX:-1761.8,regY:890.5,scaleX:0.9483,scaleY:0.9483},0).wait(127));
	...
	this.timeline.addTween(cjs.Tween.get(this.moshe).wait(995).to({regX:-1501.2,regY:428.8,scaleX:0.5017,scaleY:0.5017,x:0.05},0).wait(105).to({regX:-1761.8,regY:890.5,scaleX:0.9483,scaleY:0.9483,x:-0.05,y:0.05},0).wait(127));
	...
	this.timeline.addTween(cjs.Tween.get(this.trears_6).wait(875).to({regX:-2387.1,regY:-112.4,scaleX:0.6048,scaleY:0.6048},0).wait(1).to({regX:-1833,regY:249.4,scaleX:1,scaleY:1,x:554.05,y:361.75},0).wait(118).to({_off:true},1).wait(232));
	...
	this.timeline.addTween(cjs.Tween.get(this.trears_5).wait(879).to({regX:-2387.1,regY:-112.4,scaleX:0.6048,scaleY:0.6048},0).wait(1).to({regX:-954.9,regY:237.5,scaleX:1,scaleY:1,x:1432.15,y:349.85},0).wait(114).to({_off:true},1).wait(232));
	...
	this.timeline.addTween(cjs.Tween.get(this.trears_4).wait(873).to({regX:-2387.1,regY:-112.4,scaleX:0.6048,scaleY:0.6048},0).wait(17).to({regX:-1000.1,regY:276.5,scaleX:1,scaleY:1,x:1386.95,y:388.85},0).wait(104).to({_off:true},1).wait(232));
	...
	this.timeline.addTween(cjs.Tween.get(this.trears_3).wait(873).to({regX:-2387.1,regY:-112.4,scaleX:0.6048,scaleY:0.6048},0).wait(1).to({regX:-1746.4,regY:305.9,scaleX:1,scaleY:1,x:640.65,y:418.25},0).wait(120).to({_off:true},1).wait(232));
	...
	this.timeline.addTween(cjs.Tween.get(this.trears_2).wait(884).to({regX:-2387.1,regY:-112.4,scaleX:0.6048,scaleY:0.6048},0).wait(1).to({regX:-1803,regY:289.7,scaleX:1,scaleY:1,x:584.05,y:402.05},0).wait(109).to({_off:true},1).wait(232));
	...
	this.timeline.addTween(cjs.Tween.get(this.trears_1).wait(873).to({regX:-2387.1,regY:-112.4,scaleX:0.6048,scaleY:0.6048},0).wait(1).to({regX:-1043.9,regY:293.4,scaleX:1,scaleY:1,x:1343.15,y:405.75},0).wait(120).to({_off:true},1).wait(232));
	...
	this.timeline.addTween(cjs.Tween.get(this.moshe_cry).wait(870).to({regX:-2387.1,regY:-112.4,scaleX:0.6048,scaleY:0.6048},0).to({_off:true},125).wait(232));
	...
	this.timeline.addTween(cjs.Tween.get(this.fish2_entrance).wait(607).to({regX:-332,regY:678.1,scaleX:0.6559,scaleY:0.6559},0).wait(170).to({regX:-2533.7,regY:154.3,scaleX:0.3893,scaleY:0.3893,y:-0.05},0).to({_off:true},93).wait(357));
	...
	this.timeline.addTween(cjs.Tween.get(this.moshe_entrance2).wait(535).to({regX:2093.7,regY:1399.1,scaleX:1.416,scaleY:1.416,x:0.05},0).wait(1).to({regX:819.4,regY:1234.4,scaleX:1,scaleY:1,x:-1274.25,y:-164.7},0).wait(138).to({regX:-2008.2,regY:279.4,scaleX:0.4312,scaleY:0.4312,x:0.05,y:0},0).wait(110).to({regX:-2533.7,regY:154.3,scaleX:0.3893,scaleY:0.3893,x:0,y:-0.05},0).to({_off:true},86).wait(357));
	...
	this.timeline.addTween(cjs.Tween.get(this.moshe_happy).wait(339).to({regX:431.8,regY:838.1,scaleX:0.6224,scaleY:0.6224,x:0.05},0).wait(22).to({regX:1403.2,regY:1071.6,scaleX:1.4628,scaleY:1.4628,x:0.1,y:0.05},0).wait(5).to({regX:1161.3,regY:1005.6,scaleX:0.8667,scaleY:0.8667,x:0},0).wait(123).to({regX:1161.2,regY:1013.9,scaleX:0.7471,scaleY:0.7471,y:0},0).to({_off:true},34).wait(704));
	...
	this.timeline.addTween(cjs.Tween.get(this.charly_talk).wait(287).to({regX:431.8,regY:838.1,scaleX:0.6224,scaleY:0.6224,y:-0.05},0).to({_off:true},52).wait(888));
	...
	this.timeline.addTween(cjs.Tween.get(this.moshe_talk).wait(86).to({regX:431.8,regY:838.1,scaleX:0.6224,scaleY:0.6224,y:-0.05},0).wait(198).to({_off:true},3).wait(940));
	...
	this.timeline.addTween(cjs.Tween.get(this.moshe_entrance).wait(1).to({_off:true},85).wait(1141));
	...
	this.timeline.addTween(cjs.Tween.get(this.background_cry).wait(870).to({regX:-2387.1,regY:-112.4,scaleX:0.6048,scaleY:0.6048},0).to({_off:true},117).wait(240));
	...
	this.timeline.addTween(cjs.Tween.get(this.background4).wait(870).to({regX:-2011.7,regY:2621.9,scaleX:0.6048,scaleY:0.6048,x:227},0).wait(357));
	...
	this.timeline.addTween(cjs.Tween.get(this.charly_entrance).wait(488).to({regX:1124.9,regY:1001.9,scaleX:0.7337,scaleY:0.7337},0).wait(1).to({regX:1823.4,regY:1641,scaleX:1,scaleY:1,x:698.5,y:639.1},0).wait(46).to({regX:2093.7,regY:1399.1,scaleX:1.416,scaleY:1.416,x:0.05,y:0},0).wait(30).to({regX:718.6,regY:928,scaleX:0.9742,scaleY:0.9742,x:0},0).wait(1).to({regX:1823.4,regY:1641,scaleX:1,scaleY:1,x:1104.8,y:713},0).wait(99).to({regX:-1783,regY:332.9,scaleX:0.452,scaleY:0.452,x:0,y:0},0).to({_off:true},205).wait(357));
	...
	this.backgroud2.layerIndex = 22
	this.backgroud2.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.backgroud2).wait(870).to({regX:-2721.3,regY:2057.3,scaleX:0.6048,scaleY:0.6048},0).wait(357));
	...
	this.background3.layerIndex = 23
	this.background3.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.background3).wait(870).to({regX:-2011.7,regY:2280.8,scaleX:0.6048,scaleY:0.6048,x:227,y:1447.25},0).wait(357));
	...
	this.background1.layerIndex = 24
	this.background1.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.background1).wait(870).to({regX:-567.6,regY:2195.5,scaleX:0.6048,scaleY:0.6048,y:1395.7},0).wait(357));
	...
	this.sun1.layerIndex = 25
	this.sun1.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.sun1).wait(870).to({regX:-1379.8,regY:821.6,scaleX:0.6048,scaleY:0.6048,y:564.8},0).wait(357));

	// background0_obj_
	this.background0 = new lib.Scene_1_background0();
	this.background0.name = "background0";
	this.background0.setTransform(226.25,939.2,0.3437,0.3437,0,0,0,-69.5,2648.3);
	...
	this.background0.layerIndex = 26
	this.background0.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.background0).wait(870).to({regX:-2013,regY:1440.7,scaleX:0.6048,scaleY:0.6048},0).wait(357));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-2170.9,-2816.1,5579.700000000001,5446.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_1.png?1617814408844", id:"CachedBmp_1"},
		{src:"sounds/charlicall.mp3?1617814408844", id:"charlicall"},
		{src:"sounds/charly.mp3?1617814408844", id:"charly"},
		{src:"sounds/fish1.mp3?1617814408844", id:"fish1"},
		{src:"sounds/fish2.mp3?1617814408844", id:"fish2"},
		{src:"sounds/moshe1.mp3?1617814408844", id:"moshe1"},
		{src:"sounds/moshe2.mp3?1617814408844", id:"moshe2"},
		{src:"sounds/moshe3.mp3?1617814408844", id:"moshe3"},
		{src:"sounds/MovieFreakySceneSoundBiblecom498428129mp3copy.mp3?1617814408844", id:"MovieFreakySceneSoundBiblecom498428129mp3copy"},
		{src:"sounds/SadSoundBiblecom759843766.mp3?1617814408844", id:"SadSoundBiblecom759843766"}
	],
	preloads: []
};
